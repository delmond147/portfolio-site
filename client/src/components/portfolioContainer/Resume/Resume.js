...
export function Resume(props) {
  ...
  const projectsDetails = [
    {
      ...
      description:
        "A personal portfolio website that show case some ot the skill sets that I'm made off.",
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      ...
      <ResumeHeading
        heading={"High School"}
        subHeading={"GCE Advance Level General Certificate of Education"}
        fromDate={2018}
        toDate={2019}
      />
    </div>,
    ...
    <div className="resume-screen-container" key="work-experience">
      <ResumeHeading
        heading={"Oprime"}
        subHeading={"Full Stack Web Developer internship"}
        fromDate={2020}
        toDate={2020}
      />
      ...
      <div className="experience-description">
        <span className="resume-description-text">
          - Worked here for a professional internship. It for a full stack
          position
        </span>
        <br />
        <span className="resume-description-text">
